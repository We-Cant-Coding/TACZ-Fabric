...
public class GunFireSelectS2CPacket implements FabricPacket {
    public static final PacketType<GunFireSelectS2CPacket> TYPE = PacketType.create(new Identifier(GunMod.MOD_ID, "gun_fire_select"), GunFireSelectS2CPacket::new);
