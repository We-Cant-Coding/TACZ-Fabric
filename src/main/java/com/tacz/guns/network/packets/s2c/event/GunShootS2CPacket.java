...
public class GunShootS2CPacket implements FabricPacket {
    public static final PacketType<GunShootS2CPacket> TYPE = PacketType.create(new Identifier(GunMod.MOD_ID, "gun_shoot"), GunShootS2CPacket::new);
