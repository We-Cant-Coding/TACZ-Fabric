...
public class ServerMessageSyncedEntityDataMapping implements IMessage {
    public static final PacketType<ServerMessageSyncedEntityDataMapping> TYPE = PacketType.create(new Identifier(GunMod.MOD_ID, "server_message_synced_entity_data_mapping"), ServerMessageSyncedEntityDataMapping::new);
    ...
    public ServerMessageSyncedEntityDataMapping(PacketByteBuf buf) {
